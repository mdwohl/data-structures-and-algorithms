...
//NOTE FOR VIJ: My test was crashing for Challenge 1; Nicholas said just to delete it and move on. So I have a solution, but the test does not run.

//Worked with Riva, Darius, and Krys on these.
...
const toTitleCase = (arr) => {
  ...
  let firstSlice = word.slice(0,1);
  firstSlice = firstSlice.toUpperCase(0,1);
  let secondSlice = word.slice(1, word.length);
  let combo = firstSlice + secondSlice;
